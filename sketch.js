...
function draw() {
  ...
  if(gameState === "start"){
       ...
       textSize(70);
       textFont("harrington");
       text("Pirates Caribbean World",windowWidth-1600,windowHeight-600);
       startlevel();
  }
...
function start(){
  welcomePage = createSprite(width/2,height/3+160,windowWidth,windowHeight);
  welcomePage.addImage("welcomepage",welcomePageImg);
  welcomePage.scale = 1;
  welcomePage.visible = false;

  playButton = createSprite(windowWidth-1200,windowHeight-400);
  playButton.addImage("startbutton",playButtonImg);
  playButton.scale = 1;
  playButton.visible = false;

  controlButton = createSprite(windowWidth-1200,windowHeight-270);
  controlButton.addImage("controlsArea",controlButtonImg);
  controlButton.scale = 1;
  controlButton.visible = false;

  storyButton = createSprite(windowWidth-1200,windowHeight-150);
